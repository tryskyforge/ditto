...
<a href="https://www.star-history.com/#OWNER/ditto&Timeline">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=OWNER/ditto&type=Timeline&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=OWNER/ditto&type=Timeline" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=OWNER/ditto&type=Timeline" width="800" />
  </picture>
</a>

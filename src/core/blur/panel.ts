...
export class BlurPanel {
  ...
  private buildHeader(): HTMLElement {
    ...
    closeBtn.addEventListener('click', () => {
      document.dispatchEvent(new CustomEvent('ditto-blur:done'));
    });
  ...
  private buildPickerButton(): HTMLElement {
    ...
    btn.addEventListener('click', () => {
      document.dispatchEvent(new CustomEvent('ditto-blur:start-picker'));
    });
    return btn;
  }
  ...
  private buildResetButton(): HTMLElement {
    ...
    btn.addEventListener('click', () => {
      document.dispatchEvent(new CustomEvent('ditto-blur:reset'));
    });
    return btn;
  }
  ...
  private dispatchPresets() {
    ...
    document.dispatchEvent(new CustomEvent('ditto-blur:update-presets', { detail: { presets: active } }));
  }
